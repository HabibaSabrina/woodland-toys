...
const Banner = () => {
    ...
    return (
        <div className='flex gap-10 items-center justify-center my-20 rounded-xl bg-green-100 p-20'>
            <img className='w-5/12 rounded-xl' src="/bannerimg/banner.jpeg" alt="" />
            <div className='mr-20'>
                <h1 className='h-12 text-4xl font-bold animate-text bg-gradient-to-r from-[#225a04] via-[#38f771] to-[#114066] bg-clip-text text-transparent'>Welcome to Woodland Toys</h1>
